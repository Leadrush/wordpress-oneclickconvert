...
class One_Click_Convert {


	const VERSION = '1.0.0';

	protected $plugin_slug = 'one-click-convert';
	...
	public function enqueue_scripts() {
		...
		$on_pages = get_option( 'oneclickconvert_on_pages' );
		$off_pages = get_option( 'oneclickconvert_off_pages' );
		
		$value = get_option( 'oneclickconvert_script' );
