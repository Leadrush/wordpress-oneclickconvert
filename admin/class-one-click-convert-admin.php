 ...
 *
 * @package   One_Click_Convert_Admin
...
class One_Click_Convert_Admin {
	...
	private function __construct() {
		...
		$plugin = One_Click_Convert::get_instance();
		$this->plugin_slug = $plugin->get_plugin_slug();

		add_action( 'admin_init', array( $this, 'oneclickconvert_init' ) );
	...
	public function oneclickconvert_init() {
		
		// Check for wp_footer
		$this->check_footer();
		register_setting( 'occ-settings-group', 'oneclickconvert_script' );
		register_setting( 'occ-settings-group', 'oneclickconvert_on_pages' );
		register_setting( 'occ-settings-group', 'oneclickconvert_off_pages' );
	}
	...
	public function enqueue_admin_styles() {
		...
		if ( $this->plugin_screen_hook_suffix == $screen->id ) {
			wp_enqueue_style( $this->plugin_slug .'-admin-styles', plugins_url( 'assets/css/admin.css', __FILE__ ), array(), One_Click_Convert::VERSION );
		}
	...
	public function enqueue_admin_scripts() {
		...
		$screen = get_current_screen();
		if ( $this->plugin_screen_hook_suffix == $screen->id ) {
			wp_enqueue_script( $this->plugin_slug . '-admin-script', plugins_url( 'assets/js/admin.js', __FILE__ ), array( 'jquery' ), One_Click_Convert::VERSION );
		}
